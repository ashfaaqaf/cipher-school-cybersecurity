...
- **106 written lessons** — not topic titles, the actual teaching
- **399 terms decoded** in a searchable glossary, each explained without more jargon
...
- **212 quiz questions**, two per lesson, with an explanation on every answer
