...
- **107 written lessons** — not topic titles, the actual teaching
- **403 terms decoded** in a searchable glossary, each explained without more jargon
...
- **214 quiz questions**, two per lesson, with an explanation on every answer
